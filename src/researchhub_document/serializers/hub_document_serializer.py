...
from hub.serializers.document_hub_action_serializer import DocumentHubActionSerializer


class HubDocumentSerializer(ModelSerializer):
    ...
    def get_document(self, obj: DocumentHub):
        from researchhub_document.serializers import DocumentSerializer
